...
<!-- POSTS_START -->
- [**AI in the real development workflow: MCP Servers, GGA and persistent memory with Engram**](https://unaividal.com/en/blog/ai-workflow-mcp-gga-engram) — How I transformed a development team's workflow with custom MCP Servers, automated code review with GGA, and persistent memory across sessions with Engram. Real use cases, not theory.
...
- [**Scalable frontend architecture: React, React Native, strict TypeScript and Turborepo**](https://unaividal.com/en/blog/scalable-frontend-architecture-react-turborepo) — How to design a monorepo that shares real code between web and mobile, keeps TypeScript strict across all packages, and doesn't collapse under its own weight. Real challenges, real decisions, mistakes included.
